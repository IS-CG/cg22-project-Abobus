...
class UIBuilder:
    ...
    def add_channels_menu():
        ...
        hls_menu.add_command(label="h", command=h_channel_2)
        hls_menu.add_command(label="s", command=s_channel_2)
        hls_menu.add_command(label="v", command=v_channel)
        hls_menu.add_command(label="hs", command=hs_channel_2)
        hls_menu.add_command(label="hv", command=hv_channel)
        hls_menu.add_command(label="sv", command=sv_channel)
        channels_menu.add_cascade(label='HSV', menu=hls_menu)
